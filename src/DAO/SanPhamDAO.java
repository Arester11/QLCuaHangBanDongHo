...
public class SanPhamDAO implements DAOinterface<SanPhamDTO> {
    ...
    public int insert(SanPhamDTO t) {
        ...
        try {
            ...
            String sql = "insert into `sanpham` (`masp`, `maloai`, `tensp`, `hinhanh`, `xuatxu`, `thuonghieu`, `gianhap`, `giaban`, `soluongton`, `trangthai`) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?, 1)";
    ...
    public ArrayList<SanPhamDTO> selectAll() {
        ...
        try (Connection con = JDBC.getConnection(); Statement s = con.createStatement(); ResultSet rs = s.executeQuery("""
                                                                                                                       SELECT sanpham.masp, sanpham.maloai, sanpham.tensp, sanpham.hinhanh, sanpham.xuatxu, sanpham.thuonghieu, sanpham.gianhap, sanpham.giaban, sanpham.soluongton, sanpham.trangthai,
    ...
    public SanPhamDTO selectById(String t) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ketQua = new SanPhamDTO(masp, maloai, tensp, hinhanh, maxuatxu, mathuonghieu, soluongton, gianhap, giaban, trangthai);
            }
        } catch (SQLException e) {
            Logger.getLogger(SanPhamDAO.class.getName()).log(Level.SEVERE, null, e);
        }

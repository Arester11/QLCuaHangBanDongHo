...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 22, 2024 lúc 03:45 PM
...
INSERT INTO `ctphieuxuat` (`maphieuxuat`, `masp`, `mabh`, `soluong`, `dongia`, `thoigianbaohanh`) VALUES
(1, 1, 1, 1, 2500000.00, 3),
(1, 2, 1, 2, 2500000.00, 6),
(2, 1, 1, 2, 2250000.00, 9),
(2, 3, 2, 3, 4500000.00, 1),
(2, 4, 3, 1, 5000000.00, 12),
(3, 1, 1, 1, 3000000.00, 3),
(3, 5, 2, 1, 3500000.00, 24),
(4, 6, 4, 1, 3000000.00, 3),
(5, 2, 5, 2, 6000000.00, 7),
(5, 7, 6, 4, 2500000.00, 8),
(6, 2, 8, 2, 1800000.00, 5),
(6, 8, 7, 1, 4500000.00, 46),
(7, 1, 10, 1, 3000000.00, 12),
(7, 3, 9, 3, 2700000.00, 12),
(8, 4, 10, 1, 4000000.00, 12),
(8, 5, 9, 2, 2500000.00, 12);
